...
public class ProposalTest {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        src.oscsdkjava.domains.Reference reference = new src.oscsdkjava.domains.Reference("name", "phone");
